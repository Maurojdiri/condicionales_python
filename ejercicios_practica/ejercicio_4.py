...
# Para mí esto se da porque el programa toma los números como si fueran (str), 
# es decir, el que está mas lejos de 0 sería el número inicial es el de mayor valor.
